...
/** Herbal Bath Block */
public class HerbalBathBlock extends BlockFlowingFluid implements IHotbathBlock {
  public HerbalBathBlock(FlowingFluid flowingFluid, Properties properties) {
    super(flowingFluid, properties);
  }

  @Override
  public IFluidState getHotBathFluidState() {
    return FluidsRegister.HERBAL_BATH_FLUID.getDefaultState();
  }
