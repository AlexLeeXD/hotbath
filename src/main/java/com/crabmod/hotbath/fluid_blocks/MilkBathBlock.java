...
/** Milk Bath Block */
public class MilkBathBlock extends BlockFlowingFluid implements IHotbathBlock {
  public MilkBathBlock(FlowingFluid flowingFluid, Properties properties) {
    super(flowingFluid, properties);
  }

  @Override
  public IFluidState getHotBathFluidState() {
    return FluidsRegister.MILK_BATH_FLUID.getDefaultState();
  }
