...
/** Rose Bath Block */
public class RoseBathBlock extends BlockFlowingFluid implements IHotbathBlock {
  public RoseBathBlock(FlowingFluid flowingFluid, Properties properties) {
    super(flowingFluid, properties);
  }

  @Override
  public IFluidState getHotBathFluidState() {
    return FluidsRegister.ROSE_BATH_FLUID.getDefaultState();
  }
